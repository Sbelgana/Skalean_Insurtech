 ...
 *
 * Reference : B-08 Tache 3.1.1 + 3.1.2 + 3.1.3.
 */
...
@Module({
  ...
  providers: [CompaniesService, ContactsService, PipelinesService, StagesService],
  exports: [CompaniesService, ContactsService, PipelinesService, StagesService],
})
