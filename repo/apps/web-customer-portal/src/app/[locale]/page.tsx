/**
 * Landing placeholder -- web-customer-portal
 * Reference : task-1.4.5 Sprint 4 Phase 1
 *
 * Sprint 19 remplacera ce placeholder par la landing page marketing.
 */
    ...
    <div className="container mx-auto px-6 py-12">
      ...
      <section className="mt-12 rounded-xl border bg-muted/30 p-6">
        ...
        <p className="mt-2 text-xs uppercase tracking-wide text-muted-foreground">
          Sprint 19 implementera landing page marketing ici
        </p>
      </section>
    </div>
  );
