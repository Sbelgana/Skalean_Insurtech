/**
 * Zustand customer tenant store -- web-customer-portal
...
export const useCustomerTenantStore = create<CustomerTenantState>()(
  persist(
    (set) => ({
      tenantId: null,
      hasHydrated: false,
