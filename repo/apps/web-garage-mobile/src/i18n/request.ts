/**
 * next-intl request config -- web-garage-mobile
 ...
 * Using `as const` avoids widening to `string`, which would fail under
 * exactOptionalPropertyTypes with @formatjs-abstract types.
 */
const INTL_FORMATS = {
  dateTime: {
...
// Return type is inferred from the concrete literal to satisfy @formatjs exactOptionalPropertyTypes.
