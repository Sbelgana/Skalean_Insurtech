/**
 * Landing placeholder -- web-garage
 * Reference : task-1.4.1 Sprint 4 Phase 1
 *
 * Sprint 21 remplacera ce placeholder par le dashboard garage.
 */
    ...
    <main className="container mx-auto px-6 py-12">
      ...
      <section className="mt-10 grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        ...
        <article className="rounded-xl border bg-card p-6 shadow-sm">
          ...
          <h2 className="mt-4 text-lg font-semibold">{t('palette.sky')}</h2>
      ...
      <section className="mt-12 rounded-xl border bg-muted/30 p-6">
        ...
        <p className="mt-2 text-xs uppercase tracking-wide text-muted-foreground">
          Sprint 21 implementera dashboard garage ici
        </p>
      </section>
    </main>
  );
