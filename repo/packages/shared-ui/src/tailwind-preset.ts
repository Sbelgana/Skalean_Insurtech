/**
 * Tailwind CSS preset -- @insurtech/shared-ui Skalean Sofidemy
 * Reference : task-1.4.8 Sprint 4 Phase 1
 */

// Record<string, unknown> avoids direct tailwindcss dep in this package
const sharedPreset: Record<string, unknown> = {
  content: [],
  theme: {
    extend: {
      colors: {
